...
templated_customers_output_file = f"{LOCAL_STAGING_DIR}/customers-{templated_date_nodash}.csv"
templated_transactions_output_file = f"{LOCAL_STAGING_DIR}/transactions-{templated_date_nodash}.json"
